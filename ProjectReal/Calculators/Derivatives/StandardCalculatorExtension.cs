...
public partial class Multiply<T>
{
	...
	{
		Term<R> left = Left?.ToXBased<R>() is Term<R> term1 ? term1 : throw new ArgumentException();
		Term<R> right = Right?.ToXBased<R>() is Term<R> term2 ? term2 : throw new ArgumentException();
