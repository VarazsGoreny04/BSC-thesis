...
public abstract partial class Calculator
{
	...
	protected sealed class FunctionToken<T>
	{
		...
		private readonly Func<ValueHolder<T>> function;
		...
		/// <returns>The function of the token.</returns>
		public Func<ValueHolder<T>> Function => function;
		...
		/// <summary>
		/// Constructs a <see cref="FunctionToken{T}"/> with a <paramref name="name"/> and a <paramref name="function"/>.
		/// </summary>
		/// <param name="name">The name of the token.</param>
		/// <param name="function">The function of the token.</param>
		public FunctionToken(string name, Func<ValueHolder<T>> function)
		{
			this.name = name;
			this.function = function;
		}
	...
	/// </summary>
	/// <typeparam name="T">The type of the expected <see cref="ValueHolder{T}"/>.</typeparam>
	/// <param name="functionTokens">The functions.</param>
	/// <param name="name">The function name to search for.</param>
	/// <returns>The found function represented by a <see cref="ValueHolder{T}"/> object.</returns>
	/// <exception cref="FormatException">There must be a matching function name amongst the <paramref name="functionTokens"/>.</exception>
	protected static ValueHolder<T> GetFunctionByName<T>(FunctionToken<T>[] functionTokens, string name)
	{
	...
	/// <exception cref="FormatException">The input cannot be properly turned into an <see cref="ValueHolder{T}"/> tree.</exception>
	...
	/// <summary>
	/// Evaluates the given <see cref="ValueHolder{T}"/> tree and returns the partial results in a list. The final result is the last node of the list.
	/// </summary>
	/// <typeparam name="T">The type of the expected <see cref="ValueHolder{T}"/>.</typeparam>
	/// <param name="root">The root node of the <see cref="ValueHolder{T}"/> tree.</param>
	...
	/// <summary>
	/// Evaluates the given input and creates an <see cref="ValueHolder{T}"/> tree from it.
	/// </summary>
	/// <typeparam name="T">The type of the expected <see cref="ValueHolder{T}"/>.</typeparam>
	/// <param name="input">The given input.</param>
	/// <param name="calculator">The used <see cref="Calculator"/>.</param>
	/// <returns>The root node of the <see cref="ValueHolder{T}"/> tree.</returns>
